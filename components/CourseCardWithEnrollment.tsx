...
import { AddToMyCoursesButton } from "@/components/AddToMyCoursesButton";
import {
...
export function CourseCardWithEnrollment({ 
  course, 
  progress, 
  href, 
  ...
  return (
    <div className="bg-card rounded-xl overflow-hidden shadow-lg transition-all duration-300 ease-in-out hover:shadow-xl hover:translate-y-[-4px] border border-border flex flex-col flex-1">
      <Link
        href={href}
        prefetch={false}
        className="group hover:no-underline flex flex-col flex-1"
      >
